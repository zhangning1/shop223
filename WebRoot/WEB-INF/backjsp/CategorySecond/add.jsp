...
<%@ include file="../top.jsp" %>
 ...
 <form action="${pageContext.request.contextPath}/adminCategorySecond_add.action" method="post">                
...
<div class="well">
    <ul class="nav nav-tabs">
      <li class="active"><a data-toggle="tab">商品的二级分类</a></li>
    ...
    <form id="tab">
        ...
        <label>名字</label>
        <input id="csname" name="csname" type="text" placeholder="请输入你要添加的二级分类名字：" class="input-xlarge">
