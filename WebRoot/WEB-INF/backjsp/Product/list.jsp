...
<div class="btn-toolbar">
    <button class="btn btn-primary" id="add" name="add" onclick="addProductPage()"><i class="icon-plus"></i>添加商品</button>
    ...
    <table class="table" >
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><img alt="商品图片" width="60" height="45" src="${pageContext.request.contextPath}/<s:property value="#product.image"/>"></td>    
          <td><s:property value="#product.ppname"/></td>
          ...
          <td>
              ...
              <a href="#myModal<s:property value="#product.pid"/>" role="button" data-toggle="modal"><i class="icon-remove"></i></a>
          </td>
          
          
        </tr>
        
			<div class="modal small hide fade" id="myModal<s:property value="#product.pid"/>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			    <div class="modal-header">
			        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
			        <h3 id="myModalLabel">提示信息</h3>
			    </div>
			    <div class="modal-body">
			        <p class="error-text"><i class="icon-warning-sign modal-icon"></i>你确定要删除这个商品吗?</p>
			    </div>
			    <div class="modal-footer">
			        ...
			        <button class="btn btn-danger" type="button" data-dismiss="modal" onclick="deletee(<s:property value="#product.pid"/>)">删除<s:property value="#product.pid"/></button>
			    </div>
			</div>
        </s:iterator>
